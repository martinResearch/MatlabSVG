...
for  k=1:length(svg.layers);
    ...
    for idpoly=1:nbpolys
        ...
        fprintf(fid,'   style="opacity:1;fill:#%s;fill-opacity:%f;stroke:#%s;stroke-width:1;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" \n',colorhex,layer.colors(4,idpoly),strokecolorhex);
